"""
Django settings for educar_pagina_proyecto project.
...
SECRET_KEY = 'django-insecure-l^n1bt2ey@d=d^1#alypeaeo6%%d1n)z(zkum)eii*2#-41)m&'
...
ROOT_URLCONF = 'educar_pagina_proyecto.urls'
...
WSGI_APPLICATION = 'educar_pagina_proyecto.wsgi.application'
